...
Due to the numerical precision of JS, the error will be produced in the calculation. This is a problem that can't be avoided. We should pay attention to this problem in use, look at the following example:
...
function cutCube(volume, n) {
  ...
  return Number.isInteger(cubeRoot) && volume % n === 0 && Number.isInteger(Math.cbrt(volume / n));
}
